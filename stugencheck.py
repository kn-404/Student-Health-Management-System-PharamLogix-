...
class generalcheckupinfo(QWidget):
    def __init__(self, search_name=None, parent=None):
        ...
        self.generalcheckupdetails = [
            "UHID", "STUDENT NAME", "CLINICAL EXAMINATION", "GENERAL", "SYSTEM EXAMINATION", "SALIENT OBSERVATIONS",
            "COMPLAINTS", "DIAGNOSIS", "NAILS","INVESTIGATION ADVISED", "RESULT OF INVESTIGATION","PLAN OF ACTION",
            ...
            try:
                cursor.execute("""
                    CREATE TABLE IF NOT EXISTS general_checkup_details (
                        ...
                        NAILS VARCHAR(250),
                        INVESTIGATION_ADVISED VARCHAR(250),
